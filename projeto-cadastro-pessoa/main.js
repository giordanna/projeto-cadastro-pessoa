...
var ApiService = /** @class */ (function () {
    ...
    ApiService.prototype.getAllPessoas = function () {
        ...
        if (_environments_environment__WEBPACK_IMPORTED_MODULE_1__["environment"].production) {
            return this.http.get(API_URL + '/pessoas.json').pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(this.extrairDados));
        }
    ...
    ApiService.prototype.createPessoa = function (pessoa) {
        ...
        if (_environments_environment__WEBPACK_IMPORTED_MODULE_1__["environment"].production) {
            console.log(this.getAllPessoas());
        }
    ...
    ApiService.prototype.getPessoaById = function (pessoaId) {
        // will use this.http.get()
        if (_environments_environment__WEBPACK_IMPORTED_MODULE_1__["environment"].production) {
            return this.http.get(API_URL + '/pessoas/' + pessoaId + '.json').pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(this.extrairDados), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.handleError('getPessoaById')));
        }
